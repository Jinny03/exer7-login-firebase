...
const Profile = () => {
    ...
    return (
        <div className="h-screen max:h-screen-auto flex justify-center items-center bg-home-background">
            <div className="w-1/2 rounded-md bg-box-color flex justify-between flex-col font-sans">
                <div className="h-28 w-full justify-center flex items-center">
                    <span className="text-3xl text-white font-sans font-semibold p-3 rounded-lg">Welcome Back {userInfo?.displayName}</span>
                </div>
                ...
                {visibleForm === 'profile' &&
                    <>
                        <div className="h-28 w-full justify-center flex items-center">
                            <span className="text-3xl text-black font-sans font-semibold bg-yellow-300 p-3 rounded-lg">Update Profile</span>
                        </div>
                ...
                <>
                    <div className="h-28 w-full justify-center flex items-center">
                        <span className="text-3xl text-black font-sans font-semibold bg-yellow-300 p-3 rounded-lg">Change Password</span>
                    </div>
