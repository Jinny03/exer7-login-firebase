...
const Login = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-home-background">
            <div className="w-1/2 rounded-md bg-box-color flex justify-between flex-col">
                <div className="h-28 w-full justify-center flex items-center">
                    <span className="text-3xl text-white font-sans font-semibold p-3 rounded-lg">Welcome</span>
                </div>
                ...
                <div className="h-20 mx-auto">
                    <span className="text-sm text-gray-600">Don't have an account?  
                        <Link href={REGISTER_ROUTE}><span className="text-black font-semibold text-md" > Register Here</span></Link>
                    </span>
                </div>
            </div>
        </div>
